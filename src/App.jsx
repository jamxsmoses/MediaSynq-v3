  ...
  return <>
    <div className='appContainer w-[100vw] h-[100vh] bg-black'>
      <div className={`w-full h-[5%] bg-black ${!user ? "hidden" : "flex"} items-center justify-between`}>
        <div className="flex -tems-center justify-center w-[135px] h-[25px] bg-[#008CFF] rounded-tr-[15px] rounded-br-[15px] text-[15px] font-semibold text-black">
            MediaSynq
          </div>
          <span className="text-[#008CFF] uppercase font-bold text-[18px] mr-[10px]">{pageName}</span>
      </div>
